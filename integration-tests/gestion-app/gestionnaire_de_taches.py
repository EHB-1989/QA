...
class GestionnaireDeTaches:
    ...
    def ajouter_utilisateur(self, utilisateur):
        self.conn.execute('INSERT INTO utilisateurs (email, nom) VALUES (?, ?)', (utilisateur.email, utilisateur.nom))
        self.conn.commit()

    def ajouter_tache(self, tache):
        self.conn.execute('INSERT INTO taches (titre, description, utilisateur_email) VALUES (?, ?, ?)', (tache.titre, tache.description, tache.utilisateur_email))
        self.conn.commit()
